 ...
 * @route 'http://captionsgen.test/agenda'
 */
...
index.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/agenda',
 ...
 * @route 'http://captionsgen.test/agenda/{agenda}'
 */
...
update.definition = {
    methods: ["put","patch"],
    url: 'http://captionsgen.test/agenda/{agenda}',
...
const AgendaController = { index, store, update, destroy }
