 ...
 * @route 'http://captionsgen.test/email/verify'
 */
...
notice.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/email/verify',
 ...
 * @route 'http://captionsgen.test/email/verify/{id}/{hash}'
 */
...
verify.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'http://captionsgen.test/email/verification-notification'
 */
...
send.definition = {
    methods: ["post"],
    url: 'http://captionsgen.test/email/verification-notification',
