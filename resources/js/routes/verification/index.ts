 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/email/verify'
 */
...
notice.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/email/verify',
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/email/verify/{id}/{hash}'
 */
...
verify.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/email/verification-notification'
 */
...
send.definition = {
    methods: ["post"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/email/verification-notification',
