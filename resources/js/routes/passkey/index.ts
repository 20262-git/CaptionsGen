 ...
 * @route 'http://captionsgen.test/passkeys/login/options'
 */
...
loginOptions.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/passkeys/login/options',
 ...
 * @route 'http://captionsgen.test/passkeys/login'
 */
...
login.definition = {
    methods: ["post"],
    url: 'http://captionsgen.test/passkeys/login',
 ...
 * @route 'http://captionsgen.test/passkeys/confirm/options'
 */
...
confirmOptions.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/passkeys/confirm/options',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'http://captionsgen.test/passkeys/confirm'
 */
...
confirm.definition = {
    methods: ["post"],
    url: 'http://captionsgen.test/passkeys/confirm',
} satisfies RouteDefinition<["post"]>
