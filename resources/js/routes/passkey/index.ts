 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/login/options'
 */
...
loginOptions.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/login/options',
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/login'
 */
...
login.definition = {
    methods: ["post"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/login',
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/confirm/options'
 */
...
confirmOptions.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/confirm/options',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/confirm'
 */
...
confirm.definition = {
    methods: ["post"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/passkeys/confirm',
} satisfies RouteDefinition<["post"]>
