 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/two-factor-challenge'
 */
...
login.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/two-factor-challenge',
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-authentication'
 */
...
enable.definition = {
    methods: ["post"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-authentication',
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/confirmed-two-factor-authentication'
 */
...
confirm.definition = {
    methods: ["post"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/confirmed-two-factor-authentication',
} satisfies RouteDefinition<["post"]>
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-qr-code'
 */
...
qrCode.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-qr-code',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-secret-key'
 */
...
secretKey.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-secret-key',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-recovery-codes'
 */
...
recoveryCodes.definition = {
    methods: ["get","head"],
    url: 'https://unhearing-ragweed-flatbed.ngrok-free.dev/user/two-factor-recovery-codes',
} satisfies RouteDefinition<["get","head"]>
