 ...
 * @route 'http://captionsgen.test/two-factor-challenge'
 */
...
login.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/two-factor-challenge',
 ...
 * @route 'http://captionsgen.test/user/two-factor-authentication'
 */
...
enable.definition = {
    methods: ["post"],
    url: 'http://captionsgen.test/user/two-factor-authentication',
 ...
 * @route 'http://captionsgen.test/user/confirmed-two-factor-authentication'
 */
...
confirm.definition = {
    methods: ["post"],
    url: 'http://captionsgen.test/user/confirmed-two-factor-authentication',
} satisfies RouteDefinition<["post"]>
 ...
 * @route 'http://captionsgen.test/user/two-factor-qr-code'
 */
...
qrCode.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/user/two-factor-qr-code',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'http://captionsgen.test/user/two-factor-secret-key'
 */
...
secretKey.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/user/two-factor-secret-key',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route 'http://captionsgen.test/user/two-factor-recovery-codes'
 */
...
recoveryCodes.definition = {
    methods: ["get","head"],
    url: 'http://captionsgen.test/user/two-factor-recovery-codes',
} satisfies RouteDefinition<["get","head"]>
